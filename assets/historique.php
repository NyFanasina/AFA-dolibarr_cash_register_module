...
print load_fiche_titre($langs->trans("Historique de transaction"), '', 'caisse.png@caisse');
require "../app/Model/Caisse.php";
$caisse=new Caisse($db);
$transactions=$caisse->index(true);
?>
...
<script src="./js/bootstrap.bundle.min.js"></script>
    ...
    <div class=" d-flex justify-content-end">
        <div id="searchfield">
            <form action="../app/Controller/HistoriqueController.php" method="post" class="p-1">    
                ...
                <a href="./pdf.php" download class="btn btn-outline-primary">Exporter <i class="fas fa-file-download fs-5"></i></a>
            </form>
        </div>
    </div>
    ...
    <div class="div-table-responsive-no-min">
       <table class="noborder centpercent" >
            ...
            ?>
                ...
                <td class="center">
                    <form action="../app/Controller/HistoriqueController.php" method="post" class="d-inline">
                        <input type="hidden" name="token" value="<?php echo $_SESSION['token'] ?? '' ?>">
                        <input type="hidden" name="entrant" value="<?= $transaction->entrant ?>">
                        <input type="hidden" name="delete" value="<?= $transaction->id ?>">
                        <button class="btn" type="submit" title="supprimer" data-bs-toggle="modal" data-bs-target="#modal<?= $transaction->id ?>">
                    ...
                    <button class="btn" type="button" name="edit" value="<?= $transaction->id ?>" data-bs-toggle="modal" data-bs-target="#modalModif">
