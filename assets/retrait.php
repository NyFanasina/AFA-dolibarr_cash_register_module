...
print load_fiche_titre($langs->trans("Retrait"), '', 'caisse.png@caisse');

require "../app/Model/Caisse.php";
$caisse=new Caisse($db);
$depots=$caisse->lastInsertedRetrait();
?>
    ...
    <hr>
    <h2>Enregistrement de retrait</h2>
    <hr>
        ...
        <form action="../app/Controller/TransactionController.php" method="POST">
            <table>
                ...
                <tr>
                    ...
                    <td><input type="number" id="valeur" required name="valeur" min="100"></td>
                </tr>
   ...
   <div class="div-table-responsive-no-min">
       <table class="noborder centpercent" >
             ...
             <tr>
                ...
                <td><?= $depot->id ?></td>
                <td><?= $depot->motif  ?></td>
                <td class="amount"><?=  number_format($depot->valeur, 2,","," ")." Ar" ?></td>
                <td><?= $depot->date ?></td>
                <td>
