...
/**
 * \file    test/phpunit/CaisseFunctionalTest.php
 * \ingroup caisse
 ...
 * @package Testcaisse
 */
class CaisseFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/caisse/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('caisse/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/caisse/admin/about.php');
		$this->authenticate();
		return $this->assertContains('caisse/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('caissewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCaisse_CaisseTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCaisse_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
